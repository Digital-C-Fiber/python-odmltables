...
class SearchPage(QIWizardPage):
    def __init__(self, parent=None):
        ...
        frame_search = Qtw.QFrame()
        frame_search.setFrameShape(Qtw.QFrame.StyledPanel)
        self.vbox_search = Qtw.QVBoxLayout(frame_search)
        scroll.setWidget(frame_search)
        ...
        self.grid_searchwords.setSizeConstraint(Qtw.QLayout.SetDefaultConstraint)
        ...
        self.grid_searchprops.setSizeConstraint(Qtw.QLayout.SetDefaultConstraint)
        ...
        #self.setLayout(hbox)
        hbox.addWidget(splitter2, 1)     # give it stretch
